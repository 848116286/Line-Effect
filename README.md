...
Minecraft JE 26.2
## 使い方
線で結びたい点にmarker[tag=bot_pa],marker[tag=bot_pb]を置く
'''
...
# 伝えておくこと
- s.mcfunction内の{id:"light_blue_concrete"}を変更することで、設置するアイテムディスプレイのアイテムを変更可能。ここをリソースパックで追加したアイテムにすれば、固有のラインエフェクトを実装することができる。
- s.mcfunction内の[0.0625,0.0625,$(l)]の、0.0625を変更することで、線の形状を変えることも可能。
